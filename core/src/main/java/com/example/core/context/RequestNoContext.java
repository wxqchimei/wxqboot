...
import com.example.core.api.base.AbstractBaseRequest;
import com.example.core.constants.CommonConstants;
...
public class RequestNoContext {
    ...
    public static String getRequestNoByHttpHeader() {
        ...
        if (request == null) {
            ...
            String requestNo = request.getHeader(CommonConstants.REQUEST_NO_HEADER_NAME);
