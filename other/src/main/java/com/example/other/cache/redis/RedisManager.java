package com.example.other.cache.redis;
...
public  class RedisManager {
	...
	public Long incr(String key) {
		...
		try {
			...
			logger.error("command：incr key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public Set<String> keys(String key,String pattern) {
		...
		try {
			...
			logger.error("command：keys key:{} ex={}",key, ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public Set<String> hkeys(String key) {
		...
		try {
			...
			logger.error("command：hkeys key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public List<String> hvals(String key) {
		...
		try {
			...
			logger.error("command：hvals key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public String get(String key) {
		...
		try {
			...
			logger.error("command：get key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public String getrange(String key, long startOffSet, long endOffSet){
		...
		try {
			...
			logger.error("command=getrange, key={}, error={}", key, ExceptionUtil.getMessage(e));
		} finally {
	...
	public String spop(String key) {
		...
		try {
			...
			logger.error("command：sadd key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public Long scard(String key) {
		...
		try {
			...
			logger.error("command：scard key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public Set<String> sdiff(String... keys){
		...
		try {
			...
			logger.error(" command= sdiff, keys={}, error={}", keys, ExceptionUtil.getMessage(e));
		}finally {
			returnResource(jedis);
		}
		return null;
	...
	public Long sdiffstore(String dstkey, String... keys){
		...
		try {
			...
			logger.error("command=sdiffstore, dstkey={}, error={}", dstkey, ExceptionUtil.getMessage(e));
		}finally {
			returnResource(jedis);
		}
		return null;
	...
	public Set<String> sinter(String... keys){
		...
		try {
			...
			logger.error("command=sinter, keys={}, error={}", JSONUtil.toJsonStr(keys), ExceptionUtil.getMessage(e));
		} finally {
			returnResource(jedis);
		}
		return null;
	...
	public Long sinterstore(String dstkey, String... keys){
		...
		try {
			...
			logger.error("command=sinterstore, dstkey={}, error={}", dstkey, ExceptionUtil.getMessage(e));
		} finally {
			returnResource(jedis);
		}
		return null;
	...
	public String set(String key, String value) {
		...
		try {
			...
			logger.error("command：set key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public String setex(String key, int seconds, String value){
		...
		try {
			...
			logger.error("command=setex, key={}, seconds={}, value={}, error={}", key, seconds, value, ExceptionUtil.getMessage(e));
		} finally {
			returnResource(jedis);
		}
		return null;
	...
	public Long setnx(String key, String value){
		...
		try {
			...
			logger.error("command=setnx, key={}, error={}", key, ExceptionUtil.getMessage(e));
		} finally {
			returnResource(jedis);
		}
		return null;
	...
	public Long setrange(String key, long offset, String value){
		...
		try {
			...
			logger.error("command=setrange, key={}, error={}", key, ExceptionUtil.getMessage(e));
		} finally {
			returnResource(jedis);
		}
		return null;
	...
	public Long strlen(String key){
		...
		try {
			...
			logger.error("command=strlen, key={}, error={}", key, ExceptionUtil.getMessage(e));
		} finally {
			returnResource(jedis);
		}
		return null;
	...
	public void set(List<String> keys, List<String> values) {
		...
		try {
			...
			Long time=end-start;
			if(time>500) {
				logger.warn("ip:{} port:{} command：set list key:{} execution time:{}ms", this.host, this.port, JSONUtil.toJsonStr(keys), time);
			}
		} catch (Exception e) {
			logger.error("command：set key:{} ex={}", JSONUtil.toJsonStr(keys),ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public void mset(String... keysvalues) {
		...
		try {
			...
			logger.error("command：mset key:{} ex={}",JSONUtil.toJsonStr(keysvalues),ExceptionUtil.getMessage(e),ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public String setObject(String key, Object value) {
		...
		try {
			sj = jedisPool.getResource();
			String objectValue = JSONUtil.toJsonStr(value);
			...
			logger.error("command：setObject key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public void set(String key, List<String> strings) {
		...
		try {
			...
			logger.error("command：Pipeline set key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public String getSet(String key, String value) {
		...
		try {
			...
			logger.error("command：getSet key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public Long srem(String key, String... members) {
		...
		try {
			...
			logger.error("command：srem key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public Set<String> sunion(String... keys){
		...
		try {
			...
			logger.error("command=sunion, keys={}, error={}", JSONUtil.toJsonStr(keys), ExceptionUtil.getMessage(e));
		} finally {
			returnResource(jedis);
		}
		return null;
	...
	public Long incrby(String key, long num){
		...
		try {
			...
			logger.error("command=incrby, key={}, error={}", key, ExceptionUtil.getMessage(e));
		} finally {
			returnResource(jedis);
		}
		return null;
	...
	public Double incrbyfloat(String key, double d){
		...
		try {
			...
			logger.error("command=incrbyfloat, key={}, error={}", key, ExceptionUtil.getMessage(e));
		} finally {
			returnResource(jedis);
		}
		return null;
	...
	public Long sunionstore(String dstkey, String... keys){
		...
		try {
			...
			logger.error("command=sunionstore, dstkey={}, error={}", dstkey, ExceptionUtil.getMessage(e));
		} finally {
			returnResource(jedis);
		}
		return null;
	...
	public Long zadd(String key, Map<String, Double> map) {
		...
		try {
			...
			logger.error("command：zadd key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public void sadd(String key, List<String> strings) {
		...
		try {
			...
			logger.error("command：Pipeline sadd key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public String hget(String key, String field) {
		...
		try {
			...
			logger.error("command：hget key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public String hmset(String key, Map<String, String> hash) {
		...
		try {
			...
			logger.error("command：hmset key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public void hmset(String key, List<Map<String, String>> hash) {
		...
		try {
			...
			logger.error("command：Pipeline hmset key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public List<String> hmget(String key, String... fields) {
		...
		try {
			...
			logger.error("command：hmget key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public Long del(String key) {
		...
		try {
			...
			logger.error("command：del key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public Long decr(String key) {
		...
		try {
			...
			logger.error("command：decr key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public Long decr(String key, Long integer) {
		...
		try {
			...
			logger.error("command：decrBy key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public Long append(String key, String value) {
		...
		try {
			...
			logger.error("command：append key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public Long bitcount(String key) {
		...
		try {
			...
			logger.error("command：bitcount key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public Long bitpos(String key, boolean bool) {
		...
		try {
			...
			logger.error("command：bitpos key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public Long expire(String key, int seconds) {
		...
		try {
			...
			logger.error("command：expire key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public Long expireAt(String key, Long unixTime) {
		...
		try {
			...
			logger.error("command：expireAt key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public Long hdel(String key, String... fields) {
		...
		try {
			...
			logger.error("command：hdel key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public Boolean hexists(String key, String field){
		...
		try {
			...
			logger.error("command=hexists, key={}, error={}", key, ExceptionUtil.getMessage(e));
		} finally {
			returnResource(jedis);
		}
		return null;
	...
	public Long hincrBy(String key, String field, Long value) {
		...
		try {
			...
			logger.error("command：hincrBy key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public Double hincrbyfloat(String key, String field, Double d){
		...
		try {
			...
			logger.error("command=hincrbyfloat, key={}, error={}", key, ExceptionUtil.getMessage(e));
		} finally {
			returnResource(jedis);
		}
		return null;
	...
	public Long hlen(String key) {
		...
		try {
			...
			logger.error("command：hlen key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public Long hset(String key, String field, String value) {
		...
		try {
			...
			logger.error("command：hset key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public void hset(String key, String field, List<String> strings) {
		...
		try {
			...
			logger.error("command：Pipeline hset key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public Long hsetnx(String key, String field, String value) {
		...
		try {
			...
			logger.error("command：hsetnx key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public void hsetnx(String key, String field, List<String> strings) {
		...
		try {
			...
			logger.error("command：Pipeline hsetnx key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public Long llen(String key) {
		...
		try {
			...
			logger.error("command：llen key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public Long lpush(String key, String... strings) {
		...
		try {
			...
			logger.error("command：lpush key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public Long lpushx(String key, String... string){
		...
		try {
			...
			logger.error("command=lpushx, key={}, error={}", key, ExceptionUtil.getMessage(e));
		} finally {
			returnResource(jedis);
		}
		return null;
	...
	public void lpush(String key, List<String> strings) {
		...
		try {
			...
			logger.error("command：Pipeline lpush key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public Long lpushx(String key, String string) {
		...
		try {
			...
			logger.error("command：lpushx key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public void lpushx(String key, List<String> strings) {
		...
		try {
			...
			logger.error("command：Pipeline lpushx key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public String lindex(String key, int index) {
		...
		try {
			...
			logger.error("command：lindex key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public String lpop(String key) {
		...
		try {
			...
			logger.error("command：lpop key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public Long lrem(String key, int count, String value) {
		...
		try {
			...
			logger.error("command：lrem key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public String lset(String key, long index, String value){
		...
		try {
			...
			logger.error("command=lset, key={}, error={}", key, ExceptionUtil.getMessage(e));
		} finally {
			returnResource(jedis);
		}
		return null;
	...
	public String ltrim(String key, long start, long end){
		...
		try {
			...
			logger.error("command=ltrim, key={}, error={}", key, ExceptionUtil.getMessage(e));
		} finally {
			returnResource(jedis);
		}
		return null;
	...
	public Long move(String key, int dbIndex) {
		...
		try {
			...
			logger.error("command：move key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public Long persist(String key) {
		...
		try {
			...
			logger.error("command：persist key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public Long pexpireAt(String key, Long milliseconds) {
		...
		try {
			...
			logger.error("command：pexpireAt key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public Long pfadd(String key, String... elements) {
		...
		try {
			...
			logger.error("command：pfadd key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public Long pttl(String key) {
		...
		try {
			...
			logger.error("command：pttl key:{} ex={}",key,ExceptionUtil.getMessage(e));
			return null;
		} finally {
			if (sj != null) {
				returnResource(sj);
	...
	public Long pfcount(String key) {
		...
		try {
			...
			logger.error("command：pfcount key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public Long rpush(String key, String... strings) {
		...
		try {
			...
			logger.error("command：rpush key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public void rpush(String key, List<String> strings) {
		...
		try {
			...
			logger.error("command：Pipeline rpush key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public void rpushx(String key, List<String> strings) {
		...
		try {
			...
			logger.error("command：Pipeline rpushx key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public Long rpushx(String key, String... strings) {
		...
		try {
			...
			logger.error("command：rpushx key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public String rpop(String key) {
		...
		try {
			...
			logger.error("command：rpop key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public Double zscore(String key, String member) {
		...
		try {
			...
			logger.error("command：zscore key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public Long zcard(String key){
		...
		try {
			...
			logger.error(" command: zcard, key: {}, ex={}", key, ExceptionUtil.getMessage(e));
		}finally {
			returnResource(jedis);
		}
		return null;
	...
	public Long zcount(String key, Double min, Double max){
		...
		try {
			...
			logger.error("command= zcount, key={}, min={}, max={}, error={}", key, min, max, ExceptionUtil.getMessage(e));
		}finally {
			returnResource(jedis);
		}
		return null;
	...
	public Double zincrby(String key,double score, String member){
		...
		try {
			...
			logger.error("command= zincrby, key={}, score={}, member={}, error={}", key, score, member, ExceptionUtil.getMessage(e));
		}finally {
			returnResource(jedis);
		}
		return null;
	...
	public Long zinterstore(String dstkey, String... sets){
		...
		try {
			...
			long time = System.currentTimeMillis() - start;
			if(time > 500){
				logger.warn("ip={}, port={}, comman=zinterstore, dstkey={}, sets={}", host, port, dstkey, JSONUtil.toJsonStr(sets));
			}
			return ret;
		} catch (Exception e) {
			logger.error("command=zinterstore, dstkey={}, error={}", dstkey, ExceptionUtil.getMessage(e));
		}finally {
			returnResource(jedis);
		}
		return null;
	...
	public Long zlexcount(String key, String min, String max){
		...
		try {
			...
			logger.error(" command= zlexcount, key={}, min={}, max={}, error={}" , key, min, max, ExceptionUtil.getMessage(e));
		}finally {
			returnResource(jedis);
		}
		return null;
	...
	public Long zrank(String key, String member){
		...
		try {
			...
			logger.error("command=zrank, key={}, member={}, error={}", key, member, ExceptionUtil.getMessage(e));
		}finally {
			returnResource(jedis);
		}
		return null;
	...
	public Set<String> smembers(String key, String member) {
		...
		try {
			...
			logger.error("command：smembers key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public Long smove(String srckey, String dstkey, String member){
		...
		try {
			...
			logger.error("command=smove, srckey={}, dstkey={}, member={}, error={}", srckey, dstkey, member, ExceptionUtil.getMessage(e));
		} finally {
			returnResource(jedis);
		}
		return null;
	...
	public Boolean sismember(String key, String member) {
		...
		try {
			...
			logger.error("command：sismember key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public Boolean exists(String key) {
		...
		try {
			...
			logger.error("command：exists key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public String echo(String key) {
		...
		try {
			...
			logger.error("command：echo key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public Set<String> zrange(String key, Long start, Long end) {
		...
		try {
			...
			logger.error("command：zrange key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public Long zunionstore(String key, String... sets){
		...
		try {
			...
			logger.error("command=zunionstore, key={}, error={}", key, ExceptionUtil.getMessage(e));
		} finally {
			returnResource(jedis);
		}
		return null;
	...
	public Set<String> zrangebylex(String key, String min, String max){
		...
		try {
			...
			logger.error("command=zrangebylex, key={}, min={}, max={}, error={}", key, min, max, ExceptionUtil.getMessage(e));
		} finally {
			returnResource(jedis);
		}
		return null;
	...
	public Set<String> zrangebyscore(String key , String min, String max){
		...
		try {
			...
			logger.error("command= zrangebyscore, key={}, min={}, max={}, error={}", key, min, max, ExceptionUtil.getMessage(e));
		} finally {
			returnResource(jedis);
		}
		return null;
	...
	public Long zrem(String key, String... members) {
		...
		try {
			...
			logger.error("command：zrem key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public Long zremrangebylex(String key , String min, String max){
		...
		try {
			...
			logger.error("command= zremrangebylex, key={}, min={}, max={}, error={}", key, min, max, ExceptionUtil.getMessage(e));
		} finally {
			returnResource(jedis);
		}
		return null;
	...
	public Long zremrangebyrank(String key, long start, long end){
		...
		try {
			...
			logger.error("command= zremrangebyrank, key={}, error={}", key, ExceptionUtil.getMessage(e));
		} finally {
			returnResource(jedis);
		}
		return null;
	...
	public Long zremrangebyscore(String key, String start, String end){
		...
		try {
			...
			logger.error("command=zremrangebyscore, key={}, error={}", key, ExceptionUtil.getMessage(e));
		} finally {
			returnResource(jedis);
		}
		return null;
	...
	public Set<String> zrevrange(String key, Long start, Long end) {
		...
		try {
			...
			logger.error("command：zrevrange key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public Set<String> zrevrangebylex(String key, String min, String max){
		...
		try {
			...
			logger.error("command=zrevrangebylex, key={}, error={}", key, ExceptionUtil.getMessage(e));
		} finally {
			returnResource(jedis);
		}
		return null;
	...
	public Set<String> zrevrangbyscore(String key, String min, String max){
		...
		try {
			...
			logger.error("command=zrevrangebyscore, key={}, error={}", key, ExceptionUtil.getMessage(e));
		} finally {
			returnResource(jedis);
		}
		return null;
	...
	public Long zrevrank(String key, String member){
		...
		try {
			...
			logger.error("command=zrevrank, key={}, error={}", key, ExceptionUtil.getMessage(e));
		} finally {
			returnResource(jedis);
		}
		return null;
	...
	public Map<String, String> hgetAll(String key) {
		...
		try {
			...
			logger.error("command：hgetAll key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public List<String> brpop(String arg) {
		...
		try {
			...
			logger.error("command：brpop key:{} ex={}",arg,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public List<String> sort(String key) {
		...
		try {
			...
			logger.error("command：sort key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public List<String> srandmember(String key, int count) {
		...
		try {
			...
			logger.error("command：srandmember key:{} ex={}",key,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public void subscribe(JedisPubSub pubSub,String... channels){
		...
		try {
			...
			logger.error("command：subscribe channels:{} ex={}",channels,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
	...
	public Long publish(String channel,String msg){
		...
		try {
			...
			logger.error("command：publish channels:{} ex={}",channel,ExceptionUtil.getMessage(e));
		} finally {
			if (sj != null) {
				returnResource(sj);
			}
