...
@MapperScan(basePackages = {"com.example.other.*.dao"})
public class MybatisPlusConfig {
     ...
     */
    @Bean
    @ConditionalOnProperty(prefix = "demo", name = "muti-datasource-open", havingValue = "false")
     ...
     */
    @Bean
    @ConditionalOnProperty(prefix = "demo", name = "muti-datasource-open", havingValue = "true")
